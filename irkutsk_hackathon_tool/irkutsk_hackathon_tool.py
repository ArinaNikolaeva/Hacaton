...
class IrkutskHackathonTool:
    """Инструмент анализа транспортной доступности Иркутска для хакатона."""
   

    def __init__(self, iface):
        """Constructor.
        self.iface = iface
        self.name = "Irkutsk Hackathon Tool"
        self.version = "2025.12.hackathon"
        self.authors = "Команда хакатона ИРНИТУ"
    ...
    def run(self):
        self.iface.messageBar().pushInfo("Irkutsk Tool", 
            "Версия для хакатона 2025. Разработано командой ИРНИТУ")
